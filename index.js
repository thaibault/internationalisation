 ...
 */// endregion
// region declaration
var Documentation=exports.Documentation=function(_$$Website$class){(0,_inherits3.default)(Documentation,_$$Website$class);function Documentation(){(0,_classCallCheck3.default)(this,Documentation);return(0,_possibleConstructorReturn3.default)(this,(Documentation.__proto__||(0,_getPrototypeOf2.default)(Documentation)).apply(this,arguments))}(0,_createClass3.default)(Documentation,[{key:'initialize',// region public methods
// / region special
/**
...
}]);return Documentation}(_websiteUtilities.$.Website.class);Documentation._name='Documentation';exports.default=Documentation;// endregion
_websiteUtilities.$.Documentation=function(){for(var _len2=arguments.length,parameter=Array(_len2),_key2=0;_key2<_len2;_key2++){parameter[_key2]=arguments[_key2]}return _websiteUtilities.$.Tools().controller(Documentation,parameter)};_websiteUtilities.$.Documentation.class=Documentation;if(false){var offlineHandler=require('offline-plugin/runtime');offlineHandler.install({// NOTE: Tell the new service worker to take control immediately.
