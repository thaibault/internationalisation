...
(function() {
  ...
  main = function($) {
    ...
    Lang = (function(_super) {
      ...
      Lang.prototype.initialize = function(options, _at_currentLanguage, _at_knownLanguage, _at__$domNodeToFade, _at__replacements, _at__textNodesWithKnownLanguage) {
        var newLanguage;
        if (options == null) {
          options = {};
        }
        this.currentLanguage = _at_currentLanguage != null ? _at_currentLanguage : '';
        this.knownLanguage = _at_knownLanguage != null ? _at_knownLanguage : {};
        this._$domNodeToFade = _at__$domNodeToFade != null ? _at__$domNodeToFade : null;
        this._replacements = _at__replacements != null ? _at__replacements : [];
        this._textNodesWithKnownLanguage = _at__textNodesWithKnownLanguage != null ? _at__textNodesWithKnownLanguage : {};
      ...
      Lang.prototype._determineUsefulLanguage = function() {
        ...
        } else if (((_ref = window.localStorage) != null ? _ref.getItem(this._options.sessionDescription) : void 0) != null) {
